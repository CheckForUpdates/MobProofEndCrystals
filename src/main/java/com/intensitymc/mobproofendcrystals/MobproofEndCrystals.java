...
public class MobproofEndCrystals extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (!new File(this.getDataFolder(), "config.yml").exists()) {
            ...
            //this.radius = this.getConfig().getInt( "radius", 64 );
            //this.crystalName = this.getConfig().getString( "crystalName", "mobproof" );
        ...
        getServer().getPluginManager().registerEvents(new RemoveCrystal(this), this);
        ...
        //getServer().getPluginManager().registerEvents(new CrystalBlock(this), this);
        getServer().getPluginManager().registerEvents(new PlaceCrystal(this), this);
        //getServer().getPluginManager().registerEvents(new Proofing(this), this);
